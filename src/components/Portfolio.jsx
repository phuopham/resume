            ...
            <div className='px-2'>
                {data.map((proj, key) => (
                    <div key={key} className=' my-2 flex flex-col content-between border border-slate-200 rounded-xl'>
                        ...
                        <div className='bg-slate-200 md:hidden px-2 break-all'>
                            Link: <a href={proj.link} className='hover:underline text-sm px-2'>{proj.link}</a>
                        </div>
                        {proj.demo && <div className='bg-slate-200 md:hidden px-2'>
                            Demo: <a href={proj.demo} className='hover:underline text-sm px-2 break-all'>{proj.demo}</a>
                        </div>}
